...
@Component({
  selector: 'app-third-grid-application',
  templateUrl: './third-grid-application.component.html',
  styleUrls: ['./third-grid-application.component.css']
})
