...
@Component({
  selector: 'app-second-grid-application',
  templateUrl: './second-grid-application.component.html',
  styleUrls: ['./second-grid-application.component.css']
})
export class SecondGridApplicationComponent implements OnInit {
  @Output() fireThird = new EventEmitter<boolean>();
